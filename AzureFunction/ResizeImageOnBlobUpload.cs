...
namespace AzureFunction
{
    public static class ResizeImageOnBlobUpload
    {
        ...
        public static void Run([BlobTrigger("functionsalereps/{name}", Connection = "AzureWebJobsStorage")]Stream myBlob,
            [Blob("functionsalesreps-sm/{name}", FileAccess.Write)] Stream myBlobOutput,
